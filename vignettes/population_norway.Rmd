...
`csdata::nor_population_by_age_cats()` returns population counts for Norway. The dataset covers population as of 1 January each year, by location and age category.
